...
packages/
  ...
  @emulators/
    ...
    twilio/         # Twilio Messaging, Verify, Voice, Conversations
    stytch/         # Stytch B2B organizations, members, sessions
    nango/          # Nango connections, OAuth, proxy, webhooks
    gadget/         # Gadget GraphQL commerce API and webhooks
    faire/          # Faire External API and Messenger
    shopify/        # Shopify Admin GraphQL, OAuth, webhooks
    quickbooks/     # QuickBooks Online accounting API and OAuth
apps/
