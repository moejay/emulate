...
Local drop-in replacement for Vercel, GitHub, Google, Slack, Apple, Microsoft, Okta, AWS, Resend, Stripe, MongoDB Atlas, Clerk, Linear, Twilio, Stytch B2B, Nango, Gadget, Faire, Shopify, and QuickBooks APIs. Built for CI and no-network sandboxes. Fully stateful API emulation. Not mocks.
