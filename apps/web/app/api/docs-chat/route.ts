...
const SYSTEM_PROMPT = `You are a helpful documentation assistant for emulate, a local drop-in replacement for Vercel, GitHub, Google, Slack, Apple, Microsoft, Okta, AWS, Resend, Stripe, MongoDB Atlas, Clerk, Linear, Twilio, Stytch B2B, Nango, Gadget, Faire, Shopify, and QuickBooks APIs used in CI and no-network sandboxes.
